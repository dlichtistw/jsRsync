...
2. Das Sicherungsskript (jsRsync.js), sowie die Konfigurationsdateien (folders.rsync, optional: exclude.rsync) können beispielsweise im Wurzelverzeichnis des Datenträgers abgelegt werden, der für die Datensicherung genutzt werden soll.

3. Die Pfade der zu sichernden Ordner müssen in folders.rsync eingetragen werden. Das Format ist [Name];[Pfad]. Dabei ist [Name] ein beliebiger Name, welcher während des Sicherungsprozesses zur besseren Verständlichkeit angezeigt wird. [Pfad] ist der Pfad des Ordners.
...
HINWEIS: Der Name des Referenzordners sowie der des Sicherungsordners können auch beim Aufruf des Skripts als erster, beziehungsweise zweiter Parameter übergeben werden.
